...
TEST_F(DBBasicTestWithTimestamp, EnableDisableUDT) {
  ...
  // Make all user-defined timestamps in the Memtable as expired so flush can
  // proceed to generate another SST file. The user keys in this SST file don't
  // have user-defined timestamps either, because
  // `persist_user_defined_timestamps` flag is set to false.
